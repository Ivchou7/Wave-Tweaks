...
cls
@echo off
::Wave free tweaking utility v9.3 | Made and distributed by WAVE TWEAKS, S.R.O. ® 2025
...
echo.                                                         %p%╚══════╝╚═╝  ╚═╝╚═╝     ╚═╝  ╚═════╝    ╚═╝   ╚═╝╚══════╝╚═╝   ╚═╝      ╚═╝      ╚════╝ ╚═╝╚══════╝  %b% 
echo.                                                    %b%"═══════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                                                           %W%   Wave is not running as Admin!
echo.                                         
...
echo.
echo.                                          You can find the tutorial, more information about the utility and much more in the WAVE Tweaks Discord Server discord.gg/exm
echo.                                                                                     %p%%p%%p%%g%  WAVE TWEAKS, S.R.O. ® *                 
echo.                             %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%b%
echo.                               
echo.
echo.
...
echo.
echo.
echo.                                          %w% You are using the FREE Version of WAVE Tweaks, Unlock 10x more tweaks and completely Optimize your PC at exmtweaks.com
echo.                                                  
echo.                                                    %p%██████╗ ███████╗ ██████╗████████╗ █████╗ ██████╗ ███████╗  ██████╗  █████╗ ██╗███╗  ██╗████████╗         
echo.                                                    %p%██╔══██╗██╔════╝██╔════╝╚══██╔══╝██╔══██╗██╔══██╗██╔════╝  ██╔══██╗██╔══██╗██║████╗ ██║╚══██╔══╝        
echo.                                                    %p%██████╔╝█████╗  ╚█████╗    ██║   ██║  ██║██████╔╝█████╗    ██████╔╝██║  ██║██║██╔██╗██║   ██║            
...
chcp 437 >nul 2>&1
powershell "Checkpoint-Computer -Description 'WAVE Free utility'
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Restore point completed successfully, press "OK" to continue', 'Wave Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1 
cls
goto :resources
...
if not exist "C:\wave\Wave_Free_Power_Plan_V7.pow" (
goto download
)
if not exist "C:\wave\Autoruns.exe" (
goto download
)
if not exist "C:\wave\WAVE_Free_NVPI_V9.nip" (
goto download
)
if not exist "C:\wave\Windows_Update_Blocker.exe" (
goto download
)
if not exist "C:\wave\Nvidia_Porfile_Inspector_2.4.0.19.exe" (
goto download
)
if not exist "C:\wave\WAVE_Wallpaper_2.0.png" (
goto download
) 
...
:Download
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Resources Not found or out of date, Press "OK" To download them', 'Wave Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
echo.
chcp 437 >nul 2>&1
curl -g -k -L -# -o "C:\wave\Wave_Free_Power_Plan_V7.pow" "https://raw.githubusercontent.com/exm4L/EXM-FREE-UTILITY-RESCOURSES/refs/heads/main/Exm_Free_Power_Plan_V7.pow" >nul 2>&1
:: Power plan made by wavetweaks
chcp 65001 >nul 2>&1
timeout 1 > nul
cls
echo.
...
echo.                                                                  %p%╚═╝  ╚═╝╚══════╝╚═════╝  ╚════╝  ╚═════╝ ╚═╝  ╚═╝ ╚════╝ ╚══════╝╚═════╝ 
echo.
echo. %w%- Downloading Autoruns... %g%(Part of the Resources Used by the tool. You can find them in the C:\wave folder, they are all trusted files used by thousands of people) %b% 
echo. 
echo [==================           30.5%                         ]
echo.
chcp 437 >nul 2>&1
curl -g -k -L -# -o "C:\wave\Autoruns.exe" "https://raw.githubusercontent.com/exm4L/EXM-FREE-UTILITY-RESCOURSES/refs/heads/main/Autoruns.exe" >nul 2>&1  
...
echo.                                                                  %p%╚═╝  ╚═╝╚══════╝╚═════╝  ╚════╝  ╚═════╝ ╚═╝  ╚═╝ ╚════╝ ╚══════╝╚═════╝ 
echo.
echo. %w%- Downloading Nvidia Profile Inspector... %g%(Part of the Resources Used by the tool. You can find them in the C:\wave folder, they are all trusted files used by thousands of people) %b% 
echo.
echo [=============================51.0%                         ]
echo.
chcp 437 >nul 2>&1
curl -g -k -L -# -o "C:\wave\Nvidia_Porfile_Inspector_2.4.0.19.exe" "https://raw.githubusercontent.com/exm4L/EXM-FREE-UTILITY-RESCOURSES/refs/heads/main/Nvidia_Porfile_Inspector_2.4.0.19.exe" >nul 2>&1
...
echo.                                                                  %p%╚═╝  ╚═╝╚══════╝╚═════╝  ╚════╝  ╚═════╝ ╚═╝  ╚═╝ ╚════╝ ╚══════╝╚═════╝ 
echo.
echo. %w%- Downloading WAVE Wallpaper... %g%(Part of the Resources Used by the tool. You can find them in the C:\wave folder, they are all trusted files used by thousands of people) %b% 
echo.
echo [=============================60.0%======                   ]
echo.
chcp 437 >nul 2>&1
curl -g -k -L -# -o "C:\wave\EXM_Wallpaper_2.0.png" "https://raw.githubusercontent.com/exm4L/EXM-FREE-UTILITY-RESCOURSES/refs/heads/main/EXM_Wallpaper_2.0.png" >nul 2>&1  
chcp 65001 >nul 2>&1
timeout 1 > nul
cls
echo.
...
echo.                                                                  %p%╚═╝  ╚═╝╚══════╝╚═════╝  ╚════╝  ╚═════╝ ╚═╝  ╚═╝ ╚════╝ ╚══════╝╚═════╝ 
echo.
echo. %w%- Downloading Nvidia Profile Inspector Config... %g%(Part of the Resources Used by the tool. You can find them in the C:\wave folder, they are all trusted files used by thousands of people) %b% 
echo.
echo [=============================69.0%===========              ]
echo.
chcp 437 >nul 2>&1
curl -g -k -L -# -o "C:\wave\WAVE_Free_NVPI_V9.nip" "https://raw.githubusercontent.com/exm4L/EXM-FREE-UTILITY-RESCOURSES/refs/heads/main/EXM_Free_NVPI_V9.nip" >nul 2>&1  
:: credit to Orbmu2k (Config Made by wavetweaks) :: https://github.com/Orbmu2k/nvidiaProfileInspector/releases
chcp 65001 >nul 2>&1
timeout 1 > nul
cls
echo.
...
echo.                                                                  %p%╚═╝  ╚═╝╚══════╝╚═════╝  ╚════╝  ╚═════╝ ╚═╝  ╚═╝ ╚════╝ ╚══════╝╚═════╝ 
echo.
echo. %w%- Downloading the Windows Update Blocker Utility... %g%(Part of the Resources Used by the tool. You can find them in the C:\wave folder, they are all trusted files used by thousands of people) %b% 
echo.                                                     
echo. [=============================100.0%=======================]

echo.
chcp 437 >nul 2>&1
curl -g -k -L -# -o "C:\wave\Windows_Update_Blocker.exe" "https://raw.githubusercontent.com/exm4L/EXM-FREE-UTILITY-RESCOURSES/refs/heads/main/Windows_Update_Blocker.exe" >nul 2>&1  
:: https://www.sordum.org/downloads/?st-windows-update-blocker
chcp 65001 >nul 2>&1
timeout 1 > nul
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Downloaded resources successfully, Press "OK" To continue to the menu', 'Wave Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
cls
goto menu
...
echo.                                        %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                                                                                                              
echo.                                                  %p%[%w%1%p%]%w% General System Optimizations         %p%[%w%2%p%]%w% Power Optimizations                   %p%[%w%3%p%]%w% Keyboard and Mouse Optimizations 
echo. 
...
echo.                                                                                                                                                                                 
echo.                                                  %p%[%w%10%p%]%w% Additional / QOL                    %p%[%w%11%p%]%w% Wave Network Tweaking Utility         %p%[%w%12%p%]%w% Coming soon! %g%(Next Update)
echo.                                                                                                                                                                                
echo.                                        %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.
echo.                                                  %p%[%w%F%p%]%w% Fixes and Reverts                    %p%[%w%W%p%]%w% Completely Optimize Your PC           %p%[%w%R%p%]%w% Use Restore Point
echo.                                                                                                                                                                                 
echo.                                                  %p%[%w%P%p%]%w% 9.3 Patch Notes                      %p%[%w%X%p%]%w% Exit The Utility                      %p%[%w%E%p%]%w% WAVE Tweaks Discord %g%(More Tweaks)
echo.
echo.                                                                                  %p%%p%%p%%g%  WAVE TWEAKS, S.R.O. ® * Updated 17th of July 2025                   
echo.                                        %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
...
echo.                                            %b%"════════════════════════════════════════════════════════════════════════════════"%w%
echo.      
echo.                                                                    %p%[%w%1%p%]%w% Set wave wallpaper  
echo.  
...
echo.                                        %p%╚═╝     ╚═╝  ╚═╝   ╚═╝    ╚════╝ ╚═╝  ╚═╝╚═╝  ╚══╝ ╚════╝    ╚═╝   ╚══════╝╚═════╝    ╚════╝ ╚═╝╚═════╝
echo.                                        %b%"═══════════════════════════════════════════════════════════════════════════════════════════════════════"%w% 
echo.                                         - Completely Reworked the entire storage category
echo.                                         - Added Disable Power Saving on hard Drives
echo.                                         - Added New SSD/HDD Specific tweaks 
echo.                                         - The utility now Auto Detects your CPU in the GPU tweaks and GPU Power saving categories
echo.                                         - The utility now Auto Detects your CPU in the CPU tweaks category
echo.                                         - Updated Nvidia Profile Inspector Profile
echo.                                         - Added a disable/enable Core Isolation (HVCI) into general tweaks 
echo.                                         - Updated Disable/Enable Mitigatins, added a missing revert
echo.                                         - Reworked the way spectre and meltdown detects your cpu brand and applies accordingly
echo.                                         - Added "Check real fortnite ping" into additional tweaks
echo.                                         - Updated Intel GPU tweaks
echo.
echo.                                         - Fixed Skip/Back to menu buttons from not working
echo.                                         - Alligned/Centered missaligned ui elements
echo.                                         - Updated Reverts for storage Category
echo.                                        %b%"═══════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.         
echo.                                                                                    %p%[%w%M%p%]%w% Back to menu 
echo.
...
echo.
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Make sure to restart your PC so the tweaks properly apply. Press "OK" to exit, Thank you for using the wave utility!', 'wave Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
echo. %w% Creating a restore point... %b%                                                       
chcp 437 >nul 2>&1
powershell "Checkpoint-Computer -Description 'WAVE Network utility'
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Restore point completed successfully, press "OK" to continue', 'Wave Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1 
...
echo.
echo.                                                                                  %p%%p%%p%%g%  WAVE TWEAKS, S.R.O. ® * Updated 1st of July 2025                   
echo.                                      %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w% 
echo.                                                                 
echo.
...
:n16
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('WARNING You can only use this if you are on ethernet, if you are on wifi, press "M" on the next page, 'Wave Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
echo.                                                                                
echo.                                                           %p%[%w%4%p%]%w% Optimize Last Access Time Behaviour and 8dot3
echo.
...
echo.
echo.
echo.                                          %p%[%w%1%p%]%w% Disable SSD Power Savings            %p%[%w%2%p%]%w% Disable HDD Power Savings
echo.
echo.
echo.                                          %p%%p%%p%%p%                       %p%[%w%M%p%]%w% Back to menu  
echo.
echo.                                        %b%"════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                         %W% Disables System Power Savings for SSD or HDD
echo.                                        %b%"════════════════════════════════════════════════════════════════════════════════"%w%
...
:7war
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Note: If you want to revert anything, you can do it in our revert category on the main page of the utility', 'Wave Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
...
echo.                                            %p%╚═╝  ╚═╝ ╚═════╝    ╚═╝    ╚════╝ ╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚══╝╚═════╝ 
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('In the autoruns app, make sure to go into the LOGON Category, press "OK" to continue', 'Wave Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1

start C:\wave\Autoruns.exe
echo.
echo.
echo.
echo.                                                                                  %b%╔═══════════════════════════════════════════════════════════════╗
...
echo.                                            %p% ╚═════╝ ╚═╝     ╚═════╝ ╚═╝  ╚═╝   ╚═╝   ╚══════╝  ╚═════╝ ╚══════╝ ╚════╝  ╚════╝ ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Note: Disabling Windows Updates will break Microsoft store, if you want to use it again simply press "Enable" in windows update blocker ', 'Wave Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 >nul 2>&1
start C:\wave\Windows_Update_Blocker.exe
echo. 
echo.
echo.
echo.                                                                                  %b%╔═══════════════════════════════════════════════════════════════╗
...
echo.
echo.                                                                %p%[%w%13%p%]%w% Fix Fivem not opening
echo.
echo.
echo.                                                                   %p%[%w%M%p%]%w% Back to menu                                         
echo.                                                                              
...
:5war
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Do NOT do these if your pc has bad overheating issues', 'Wave Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
timeout /t 1 /nobreak > nul
chcp 65001 >nul 2>&1
...
echo. 
echo.                                               %W%  Reverts gpu tweaks made by the wave free utility
echo.                                        %b%"═════════════════════════════════════════════════════════════"
echo.
set /p input=:
...
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Disabling Core isolation will boost performance, but leave your PC more vulnrable to driver based attacks', 'Wave Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
timeout /t 1 /nobreak > nul
chcp 65001 >nul 2>&1
:coreisolation
cls
...
:2war
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Do NOT do these if your pc has overheating issues', 'Wave Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
timeout /t 1 /nobreak > nul
chcp 65001 >nul 2>&1
:2
...
echo.                                             
echo.                                                            %p%[%w%1%p%]%w% Apply Wave Free Power Plan V7               
echo.                                                                                           
...
echo %w% Import Wave Free Power Plan V7%b%
powercfg -import "C:\wave\Wave_Free_Power_Plan_V7.pow"
powercfg.cpl
...
echo %w% - Applying WAVETWEAKS Nvidia Profile Inspector Profile %g%(optimizes nvidia control panel 3D settings and much more) %b%
start "" /wait "C:\wave\Nvidia_Porfile_Inspector_2.4.0.19.exe" "C:\wave\WAVE_Free_NVPI_V9.nip" 
